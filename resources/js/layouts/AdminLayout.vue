<template>
  <div class="flex h-screen">
    ...
    <div class="flex-1 flex flex-col">
      <main class="flex-1 overflow-autow-full  ">
       <div class="w-full">
         <slot />
       </div>
      </main>
...
const menuItems = [
   {
    name: 'Products',
    link: '/products',
    icon: `<svg xmlns="http://www.w3.org/2000/svg"class="w-5 h-5 text-primarys group-hover:text-gray-700 transition-colors duration-200" viewBox="0 0 512 512">
  ...
  },
   {
    ...
    icon: `<svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-primarys group-hover:text-gray-700 transition-colors duration-200" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    icon: `<svg xmlns="http://www.w3.org/2000/svg"  class="w-5 h-5 text-primarys group-hover:text-gray-700 transition-colors duration-200" viewBox="0 0 32 32">
 ...
 
  {
    name: 'Users',
    link: '/',
    icon: `<svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-primarys group-hover:text-gray-700 transition-colors duration-200" fill="currentColor" viewBox="0 0 24 24">
